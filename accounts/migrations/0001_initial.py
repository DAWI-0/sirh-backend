    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('RH', 'Manager RH'), ('EMPLOYE', 'Employé')], default='EMPLOYE', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matrice_competences', models.JSONField(blank=True, default=list, null=True)),
            ],
            options={
